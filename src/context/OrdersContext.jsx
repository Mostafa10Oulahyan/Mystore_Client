...
export function OrdersProvider({ children }) {
    ...
    const fetchOrders = useCallback(async (userId) => {
        ...
        `)
            ...
            console.log("Supabase Fetch Response:", { dataLength: data?.length, error });
            ...
            const mapped = data.map((order) => ({
                ...
                statusHistory: (order.order_status_history || []).sort((a, b) => new Date(a.created_at) - new Date(b.created_at))
            }));
    ...
    const createOrder = useCallback(async ({ userId, orderData, cartItems }) => {
        ...
        try {
            ...
            console.error("Create Create Order Error Full Object:", err);
    ...
    // ─── Cancel Order ───
    const cancelOrder = useCallback(async (userId, orderId) => {
